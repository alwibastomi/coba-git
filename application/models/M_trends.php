...
class M_trends extends CI_Model
{
  ...
  function _post($name , $xss = true){
     ...
     * @throws \Exception
     */
    public function getRelatedSearchQueries($keyWordList=null, $category=0, $time='', $property='', $sleep=0.5)
    {
     ...
     * @throws \Exception
     */
    public function interestOverTime($kWord, $category=0, $time='now 7-d', $property='')
    {
      $payload = [
        'hl' => $this->options['hl'],
        'tz' => $this->options['tz'],
